  ...
  const filteredConversations = useMemo(() => {
    if (selectedFilter === "team") {
      return conversations.filter(
        (conversation) => conversation.type === "team",
      );
    }
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-semibold text-gray-800">
              {conversation.type === "team"
                ? conversation.team?.name || "Team Chat"
                : "Direct Chat"}
            </p>
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Encrypted communication with your teams and teammates.
            </p>
          </div>
          {keyStatusBadge}
        </div>
                  ...
                  {activeMessages.map((message) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p
                          className={`text-xs text-gray-400 mt-1 ${isSelf ? "text-right" : "text-left"}`}
                        >
                      ...
                      {searchResults.map((result) => (
                        <div key={result._id} className="text-sm">
                          <p className="font-semibold text-gray-800">
                            {activeParticipants[result.sender]?.name ||
                              "Member"}
                          ...
                          <p className="text-gray-600">
                            {result.plaintext || "Encrypted message"}
                          </p>
                        </div>
                      ))}
                    </div>
