...
const TaskWorkspace = () => {
  ...
  const fetchWorkspace = async () => {
    try {
      ...
      const filteredActivity = (activityRes.data.activities || []).filter(
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <div className="flex flex-wrap gap-3 mt-6 text-xs">
                <span className={`badge ${statusBadgeClasses}`}>
            ...
            <div className="space-y-3 min-w-[220px]">
              ...
              <div className="rounded-2xl bg-white/10 border border-white/10 p-4">
                ...
                <p className="text-lg font-semibold">
                  {task.team?.name || "Team workspace"}
                </p>
                <p className="text-white/60 text-sm">
                  {task.team?.members?.length || 0} collaborators
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <section className="lg:col-span-2 card p-6 space-y-6">
            ...
            {attachments.length === 0 ? (
              <div className="border border-dashed border-gray-200 rounded-2xl p-10 text-center text-gray-500">
                Drop assets here or use the "Add Files" control to bring your
                code, PDFs, and docs into this workspace.
              </div>
            ) : (
              <div className="space-y-4">
                {attachments.map((attachment) => (
                  <div
                    key={attachment._id}
                    className="flex items-start justify-between gap-4 p-4 rounded-2xl border border-gray-100 hover:border-gray-200"
                  >
          ...
          <section className="card p-6 space-y-6">
            <div>
              ...
              <h2 className="text-2xl font-semibold">Task Checklist</h2>
            </div>
              ...
              <div className="space-y-3">
                <div>
                  <div className="flex items-center justify-between text-sm text-gray-600 mb-2">
                    <span>
                      {completedChecklistItems} of {checklistItems.length}{" "}
                      complete
                    </span>
                    <span>
                      {Math.round(
            ...
            <div className="space-y-4 text-sm text-gray-600">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p>
                    Only teammates assigned to {task.team?.name} can contribute
                    here.
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p>
                    Every upload is tracked with author, time, and file diff
                    context.
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p>
                    {task.team?.members?.length || 0} collaborators notified on
                    change events.
                  </p>
                </div>
              </div>
        ...
        <section className="card p-6">
          ...
          {activity.length === 0 ? (
            <p className="text-gray-500 text-sm">
              No activity captured for this task yet.
            </p>
          ) : (
            <div className="space-y-4">
              {activity.map((item) => (
              ...
              <div className="flex-1 overflow-auto p-6 bg-gray-50">
                ...
                {preview.type === "image" && (
                  <img
                    ...
                    className="max-h-[70vh] mx-auto rounded-2xl"
                  />
                )}
              </div>
            </div>
